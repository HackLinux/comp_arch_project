...
add wave -noupdate -label {CPU address} -radix unsigned /cache_tb/m_address
...
add wave -noupdate -label {Cache address} -radix unsigned /cache_tb/s_address
...
WaveRestoreCursors {{Cursor 1} {4784399386 ps} 0}
...
update
WaveRestoreZoom {4784369606 ps} {4784427394 ps}

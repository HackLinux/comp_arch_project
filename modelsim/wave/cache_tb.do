...
add wave -noupdate -expand -group Cache_out -color Firebrick -itemcolor Firebrick -label tag(r) -radix unsigned -childformat {{/cache_tb/xcache/tag_out(1) -radix unsigned} {/cache_tb/xcache/tag_out(0) -radix unsigned}} -subitemconfig {/cache_tb/xcache/tag_out(1) {-color Firebrick -height 15 -itemcolor Firebrick -radix unsigned} /cache_tb/xcache/tag_out(0) {-color Firebrick -height 15 -itemcolor Firebrick -radix unsigned}} /cache_tb/xcache/tag_out
...
WaveRestoreCursors {{Cursor 1} {69473264 ps} 0}
...
update
WaveRestoreZoom {69453228 ps} {69499772 ps}

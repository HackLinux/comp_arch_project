...
add wave -noupdate -expand -group {proc 0
...
add wave -noupdate -expand -group {proc 1
...
add wave -noupdate -group debug /split_cache_tb/xhtps/last_used
add wave -noupdate -group debug /split_cache_tb/array_length
add wave -noupdate -group debug /split_cache_tb/interleaved
add wave -noupdate -group debug /split_cache_tb/start_addr_0
add wave -noupdate -group debug /split_cache_tb/start_addr_1
add wave -noupdate -group debug /split_cache_tb/end_addr_0
add wave -noupdate -group debug /split_cache_tb/end_addr_1
add wave -noupdate -group debug /split_cache_tb/array_start_addr
add wave -noupdate -group debug /split_cache_tb/test_1
add wave -noupdate -group debug /split_cache_tb/test_2
add wave -noupdate -group debug /split_cache_tb/P0_done
add wave -noupdate -group debug /split_cache_tb/P1_done
add wave -noupdate -divider cache
add wave -noupdate -expand -group {cache 0} -group {sram controller
} -group {interface
} -group {cpu
...
add wave -noupdate -expand -group {cache 0} -expand -group {coherence circuit
...
add wave -noupdate -expand -group {cache 0} -expand -group {coherence circuit
} -label {last used} /split_cache_tb/xhtps/last_used_0
add wave -noupdate -expand -group {cache 0} -expand -group {coherence circuit
} -group {internals
...
add wave -noupdate -expand -group {cache 0} -group {sram
...
add wave -noupdate -expand -group {cache 1} -group {sram controller
} -group {interface
} -group {cpu
...
add wave -noupdate -expand -group {cache 1} -expand -group {coherence circuit
} -expand -group {interface
} -group {cpu local
...
add wave -noupdate -expand -group {cache 1} -expand -group {coherence circuit
} -label {last used} /split_cache_tb/xhtps/last_used_1
add wave -noupdate -expand -group {cache 1} -expand -group {coherence circuit
} -group {internals
...
add wave -noupdate -expand -group {cache 1} -group {sram
